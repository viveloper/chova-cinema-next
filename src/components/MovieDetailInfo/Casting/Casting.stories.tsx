...
export default {
  title: 'Components/Casting',
  component: Casting,
  // More on argTypes: https://storybook.js.org/docs/react/api/argtypes
  argTypes: {},
} as ComponentMeta<typeof Casting>;

const Template: ComponentStory<typeof Casting> = (args) => <Casting {...args} />;
...
Primary.args = {
  ...
  ].map((item) => ({ ...item, StaffImage: process.env.NEXT_PUBLIC_S3_BASE_URL + item.StaffImage })),
};
